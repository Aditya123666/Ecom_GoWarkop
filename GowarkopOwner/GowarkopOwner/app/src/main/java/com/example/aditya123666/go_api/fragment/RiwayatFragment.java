...
import com.example.aditya123666.go_api.adapter.RiwayatAdapter;
...
public class RiwayatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new RiwayatAdapter(getActivity(), listMenu);
        mRecyclerView = v.findViewById(R.id.rv_list_riwayat);
        ...
        call.enqueue(new Callback<ResponsePesan>() {
            ...
            public void onResponse(Call<ResponsePesan> call, Response<ResponsePesan> response) {
                if (response.isSuccessful()){
                    ...
                    mRecyclerView.setAdapter(new RiwayatAdapter(getActivity(), listMenu));
